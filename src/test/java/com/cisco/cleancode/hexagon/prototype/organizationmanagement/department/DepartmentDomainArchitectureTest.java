...
class DepartmentDomainArchitectureTest {
  ...
  public static final String ADAPTER_OUT_PERSISTENCE = BASE + ".adapter.out.persistence";

  /** The constant APPLICATION_PORT_IN. */
  public static final String APPLICATION_PORT_IN = BASE + ".application.port.in";

  /** The constant APPLICATION_PORT_OUT. */
  public static final String APPLICATION_PORT_OUT = BASE + ".application.port.out";

  /** The constant APPLICATION_SERVICE. */
  public static final String APPLICATION_SERVICE = BASE + ".application.service";
  ...
  @BeforeAll
  static void setUp() {
    importedClasses = new ClassFileImporter().importPackages(BASE);
  }
